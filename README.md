...
# Animated textures for models using a video

I made a [youtube video](https://youtu.be/LKq2NTXv2Tw) about how you can make custom animated textures for models using a video for Minecraft.
